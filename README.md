# DiScO-open
Codes for paper "Diverse Thinking Schemata Elicits Better Reasoning in Large Language Models"
## Usage
### Installtion
```
...
- inference_strategies.py: Process samples with incomplete reasoning (where the answer is null) and perform Initial Truncation or Truncation with Repetition Elimination to enable continued reasoning completion.
